...
void Scene::addParticleRandom() {
    ...
    particles.emplace_back(pos, vel, particleRadius, 1.0f, glm::vec3(1.0f, 0.0f, 0.0f));
}

// ============================================================================
// Добавление произвольной частицы
// ============================================================================
void Scene::addParticle(const glm::vec2& pos,
                        const glm::vec2& vel,
                        float radius,
                        float mass,
                        const glm::vec3& color) {
    if (particles.size() >= 50) return;
    particles.emplace_back(pos, vel, radius, mass, color);
}
